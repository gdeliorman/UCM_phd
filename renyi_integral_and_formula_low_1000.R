...
##n=1000
#ica:, , -0.3511859, 0.1233315
start_time<- Sys.time()
print(start_time)
print("n1000 low renyi integrals formulas")
highmetricn1000<-matrix(c(0.7, 0.759604, 0.9 ,0.7, 0.7111961,0.9  ), ncol = 6)
...
write.csv(renyis_formulas,"renyis_formulas_low_1000.csv")
...
write.csv(renyis_integral,"renyis_integral_low_1000.csv")
...
write.csv(ica_1_vs_corr,"ica_1_vs_corr_low_1000.csv")
