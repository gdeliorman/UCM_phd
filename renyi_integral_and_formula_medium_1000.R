...
##n=1000
#ica:, 0.7247139, 0.5252102
start_time<- Sys.time()
print(start_time)
print("n1000 medium renyi integrals formulas")
highmetricn1000<-matrix(c(0.5,0.759604,-0.2, 0.7, 0.7111961, 0.1 ), ncol = 6)
...
write.csv(renyis_formulas,"renyis_formulas_medium_1000.csv")
...
write.csv(renyis_integral,"renyis_integral_medium_1000.csv")
...
write.csv(ica_1_vs_corr,"ica_1_vs_corr_medium_1000.csv")
