...
##n=1000
#ica:0.96536978, 0.931938804
start_time<- Sys.time()
print(start_time)
print("n1000 high renyi integrals formulas")
highmetricn1000<-matrix(c(0.8, 0.759604,  0.4,  0.3, 0.7111961,  0.2), ncol = 6)
...
write.csv(renyis_formulas,"renyis_formulas_high_1000.csv")
...
write.csv(renyis_integral,"renyis_integral_high_1000.csv")
...
write.csv(ica_1_vs_corr,"ica_1_vs_corr_high_1000.csv")
